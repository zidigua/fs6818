...
CROSS_COMPILE ?=  /opt/gcc-4.5.1/bin/arm-none-linux-gnueabi-
...
clean: $(clean-dirs)
	...
	@find $(if $(KBUILD_EXTMOD), $(KBUILD_EXTMOD), .) $(RCS_FIND_IGNORE) \
		...
		-o -name '*.gcno' -o -name '*.bin' \) -type f -print | xargs rm -f
